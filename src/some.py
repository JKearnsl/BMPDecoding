...
img = Image.open("/home/jkearnsl/Загрузки/image.png")
...
def main():
    os.mkdir("/home/jkearnsl/Рабочий стол/sup")
    for channel in range(3):
        for bit_pos in range(8):
            ...
            out_img.save(f"/home/jkearnsl/Рабочий стол/sup/{'RGB'[channel]}-{bit_pos}.png")
